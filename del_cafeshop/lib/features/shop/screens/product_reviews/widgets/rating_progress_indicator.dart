import 'package:del_cafeshop/features/shop/screens/product_reviews/widgets/progress_indicator_rating.dart';
...
class OverallProductRating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [ 
        Expanded(flex: 3,child: Text('4.0', style: Theme.of(context).textTheme.displayLarge)),
        const Expanded(
          flex: 7,
          child: Column(
            children: [
